  ...
  const PokemonDetails = async () => {
    try {
      ...
      setDetailsData({
        ...
        moves:
          convertedData.moves.length > 9
            ? convertedData.moves.splice(0, 9)
            : convertedData.moves,
        image: convertedData.sprites.other
          ? convertedData.sprites.other.dream_world.front_default == null
            ? convertedData.sprites.other.home.front_default
        ...
        <div className="details-box">
          <div className="left">
            ...
            <div className="height">
              <h2>
                Height :{" "}
                {isNaN(detailsData?.height)
                  ? "N/A"
                  : Number.parseFloat(detailsData?.height * 0.1).toFixed(1)}
                m
              </h2>
            </div>
            <div className="weight">
              <h2>
                ...
                {isNaN(detailsData?.height)
                  ? "N/A"
                  : Number.parseFloat(detailsData?.weight / 10).toFixed(1)}
                kg
              </h2>
            </div>
          </div>
            ...
            <div className="stats">
              ...
              <div className="stats-data">
                {stats?.map((element, index) => (
                  <div key={index} className="stats-data-details">
